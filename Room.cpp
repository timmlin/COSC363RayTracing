...
vector<SceneObject*> intialiseRoom(vector<SceneObject*> sceneObjects)
{
    ...
    Plane *floor = new Plane (glm::vec3(MIN_X_VALUE, -15, MAX_Z_VALUE),   // bottom left
                              glm::vec3(MAX_X_VALUE, -15, MAX_Z_VALUE),           // bottom right
                              glm::vec3(MAX_X_VALUE, -15, MIN_Z_VALUE),          // top right
    ...
    Plane *ceiling = new Plane (glm::vec3(MIN_X_VALUE, 30, MAX_Z_VALUE),   // bottom left
                                glm::vec3(MAX_X_VALUE, 30, MAX_Z_VALUE),           // bottom right
                                glm::vec3(MAX_X_VALUE, 30, MIN_Z_VALUE),          // top right
    ...
    Plane *leftWall = new Plane (glm::vec3(MIN_X_VALUE, 30, MAX_Z_VALUE),   //top right
                                 glm::vec3(MIN_X_VALUE, -15, MAX_Z_VALUE),  //bottom right
    ...
    Plane *rightWall = new Plane (glm::vec3(MAX_X_VALUE, 30, MAX_Z_VALUE),    //top right
